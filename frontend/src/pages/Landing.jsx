          ...
          <section className="py-5 text-center container">
            <div className="row py-lg-5">
              <div className="col-lg-8 col-md-8 mx-auto">
                ...
                <br />
                <p className="alert alert-warning">Please note that AalimGPT is still a work in progress and we are only in Beta testing. Its responses may not always be fully accurate or authentic. Use the information provided by AalimGPT at your own discretion and always verify it with other reliable sources.</p>
              </div>
            </div>
          </section>
        </div>
